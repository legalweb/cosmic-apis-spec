...
func (o *CreateIntroducerOK) Error() string {
	return fmt.Sprintf("[POST /v1/introducers][%d] createIntroducerOK  %+v", 200, o.Payload)
}

func (o *CreateIntroducerOK) GetPayload() models.V1CreateIntroducerResponse {
	return o.Payload
}

func (o *CreateIntroducerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
