...
func (o *GetOrganisationOK) Error() string {
	return fmt.Sprintf("[GET /v1/organisations/{organisation_id}][%d] getOrganisationOK  %+v", 200, o.Payload)
}

func (o *GetOrganisationOK) GetPayload() *models.V1GetOrganisationResponse {
	return o.Payload
}
