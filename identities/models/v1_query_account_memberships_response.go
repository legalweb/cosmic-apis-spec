...
// V1QueryAccountMembershipsResponse v1 query account memberships response
...
func (m *V1QueryAccountMembershipsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1QueryAccountMembershipsResponse) UnmarshalBinary(b []byte) error {
	var res V1QueryAccountMembershipsResponse
